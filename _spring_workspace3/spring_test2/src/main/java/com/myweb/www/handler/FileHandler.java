...
public class FileHandler {
	...
	public List<FileVO> uploadFile(MultipartFile[] files){
		...
		// D:\myProject\_java\_fileUpload\\2024\\01\\10\\11111_apple.jpg
	...
	private boolean isImageFile(File storeFile) throws IOException{
		String mimeTypr = new Tika().detect(storeFile);
		return mimeTypr.startsWith("image")? true : false;
	}
