...
public class RootConfig {
	...
	public DataSource dataSource() {
		...
		//mysql 드라이버 연결당 cache statement의 수에 관한 설정 : 250 ~ 500사이 권장
		hikariConfig.addDataSourceProperty("dataSource.prepStmtsCachSize", "250");
		//connection 당 캐싱할 preparedstatement의 개수 지정 옵션 : default 256
		hikariConfig.addDataSourceProperty("dataSource.prepStmtsCachSqlLimit", "true");
